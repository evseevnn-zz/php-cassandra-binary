...
class QueryTextTest extends Setup\QueryTestCase {
    ...
    public function testTextColumn()
    {
        ...
        self::$connection->query('INSERT INTO TextTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz', 'bar' => 'barbaz']);
    ...
    public function testTextMap()
    {
        ...
        self::$connection->query('INSERT INTO TextMapTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz', 'bar' => ['barbaz' => 'bazbar']]);
    ...
    public function testTextSet()
    {
        ...
        self::$connection->query('INSERT INTO TextSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz', 'bar' => ['barbaz', 'bazbar']]);
        ...
        self::$connection->query('INSERT INTO TextSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz2', 'bar' => ['bazbar', 'barbaz']]);
    ...
    public function testTextList()
    {
        ...
        self::$connection->query('INSERT INTO TextListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz', 'bar' => ['barbaz', 'bazbar']]);
        ...
        self::$connection->query('INSERT INTO TextListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz2', 'bar' => ['bazbar', 'barbaz']]);
