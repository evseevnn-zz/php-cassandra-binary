...
class QueryDoubleTest extends Setup\QueryTestCase {
    ...
    public function testDoubleRow()
    {
        ...
        self::$connection->query('INSERT INTO DoubleTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => '52']);
    ...
    public function testDoubleMap()
    {
        ...
        self::$connection->query('INSERT INTO DoubleMapTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['52' => '25']]);
    ...
    public function testDoubleSet()
    {
        ...
        self::$connection->query('INSERT INTO DoubleSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['25', '52']]);
        ...
        self::$connection->query('INSERT INTO DoubleSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '22', 'bar' => ['52', '25']]);
    ...
    public function testDoubleList()
    {
        ...
        self::$connection->query('INSERT INTO DoubleListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['52', '25']]);
        ...
        self::$connection->query('INSERT INTO DoubleListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '22', 'bar' => ['25', '52']]);
