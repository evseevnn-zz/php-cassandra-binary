...
class QueryAsciiTest extends Setup\QueryTestCase {
    ...
    public function testAsciiColumn()
    {
        ...
        self::$connection->query('INSERT INTO AsciiTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz', 'bar' => 'barbaz']);
    ...
    public function testAsciiMap()
    {
        ...
        self::$connection->query('INSERT INTO AsciiMapTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz', 'bar' => ['barbaz' => 'bazbar']]);
    ...
    public function testAsciiSet()
    {
        ...
        self::$connection->query('INSERT INTO AsciiSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz', 'bar' => ['barbaz', 'bazbar']]);
        ...
        self::$connection->query('INSERT INTO AsciiSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz2', 'bar' => ['bazbar', 'barbaz']]);
    ...
    public function testAsciiList()
    {
        ...
        self::$connection->query('INSERT INTO AsciiListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz', 'bar' => ['barbaz', 'bazbar']]);
        ...
        self::$connection->query('INSERT INTO AsciiListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => 'baz2', 'bar' => ['bazbar', 'barbaz']]);
