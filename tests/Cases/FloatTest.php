...
class QueryFloatTest extends Setup\QueryTestCase {
    ...
    public function testFloatMap()
    {
        ...
        self::$connection->query('INSERT INTO FloatMapTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['52' => '25']]);
    ...
    public function testFloatSet()
    {
        ...
        self::$connection->query('INSERT INTO FloatSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['25', '52']]);
        ...
        self::$connection->query('INSERT INTO FloatSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '22', 'bar' => ['52', '25']]);
    ...
    public function testFloatList()
    {
        ...
        self::$connection->query('INSERT INTO FloatListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['52', '25']]);
        ...
        self::$connection->query('INSERT INTO FloatListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '22', 'bar' => ['25', '52']]);
