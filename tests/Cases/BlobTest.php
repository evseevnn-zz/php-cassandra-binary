...
class QueryBlobTest extends Setup\QueryTestCase {
    ...
    public function testBlobMap()
    {
        ...
        self::$connection->query('INSERT INTO BlobMapTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['52' => '25']]);
    ...
    public function testBlobSet()
    {
        ...
        self::$connection->query('INSERT INTO BlobSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['25', '52']]);
        ...
        self::$connection->query('INSERT INTO BlobSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '22', 'bar' => ['52', '25']]);
    ...
    public function testBlobList()
    {
        ...
        self::$connection->query('INSERT INTO BlobListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['52', '25']]);
        ...
        self::$connection->query('INSERT INTO BlobListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '22', 'bar' => ['25', '52']]);
