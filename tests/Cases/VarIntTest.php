...
class QueryVarIntTest extends Setup\QueryTestCase {
    ...
    public function testVarIntColumn()
    {
        ...
        self::$connection->query('INSERT INTO VarIntTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => '52']);
    ...
    public function testVarIntSet()
    {
        ...
        self::$connection->query('INSERT INTO VarIntSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['25', '52']]);
        ...
        self::$connection->query('INSERT INTO VarIntSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '22', 'bar' => ['52', '25']]);
    ...
    public function testVarIntList()
    {
        ...
        self::$connection->query('INSERT INTO VarIntListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['52', '25']]);
        ...
        self::$connection->query('INSERT INTO VarIntListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '22', 'bar' => ['25', '52']]);
