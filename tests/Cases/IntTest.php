...
class QueryIntTest extends Setup\QueryTestCase {
    ...
    public function testIntMap()
    {
        ...
        self::$connection->query('INSERT INTO IntMapTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['52' => '25']]);
    ...
    public function testIntSet()
    {
        ...
        self::$connection->query('INSERT INTO IntSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['25', '52']]);
        ...
        self::$connection->query('INSERT INTO IntSetTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '22', 'bar' => ['52', '25']]);
    ...
    public function testIntList()
    {
        ...
        self::$connection->query('INSERT INTO IntListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '2', 'bar' => ['52', '25']]);
        ...
        self::$connection->query('INSERT INTO IntListTest (foo, bar) VALUES (:foo, :bar)', ['foo' => '22', 'bar' => ['25', '52']]);
